 ...
 * @author ssdd
 */
public class Ojito extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ojito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
