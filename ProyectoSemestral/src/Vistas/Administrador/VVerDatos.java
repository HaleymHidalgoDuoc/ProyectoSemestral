 ...
 * @author cetecom
 */
public class VVerDatos extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VVerDatos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
