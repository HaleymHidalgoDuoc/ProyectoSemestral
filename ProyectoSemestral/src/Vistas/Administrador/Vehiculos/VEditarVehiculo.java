 ...
 * @author cetecom
 */
public class VEditarVehiculo extends javax.swing.JFrame {

    /**
     * Creates new form Nuevo_vendedor1
     */
    public VEditarVehiculo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VEditarVehiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
