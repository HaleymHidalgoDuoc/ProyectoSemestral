 ...
 * @author cetecom
 */
public class VVerVehiculo extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VVerVehiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
