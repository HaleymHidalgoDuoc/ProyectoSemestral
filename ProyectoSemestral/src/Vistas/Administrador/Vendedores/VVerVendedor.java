 ...
 * @author cetecom
 */
public class VVerVendedor extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VVerVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
